...
export function parseTimeMoment(time, cFormat, locale) {
  return moment(time).tz(locale || 'Asia/Shanghai').format(cFormat || 'YYYY-MM-DD HH:mm:ss');
}
...
export function areaFormatter(value) {
  let v = []
  v[0] = value.substring(0, 2) + '0000'
  v[1] = value.substring(0, 4) + '00'
  v[2] = value
